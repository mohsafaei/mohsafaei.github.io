...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-4">
        {% include video.liquid path="assets/video/videos1.mp4" class="img-fluid rounded z-depth-1" controls=true %}
    </div>
    <div class="col-sm mt-3 mt-md-4">
        {% include video.liquid path="assets/video/videos2.mp4" class="img-fluid rounded z-depth-1" controls=true %}
    </div>
    <div class="col-sm mt-3 mt-md-4">
        {% include video.liquid path="assets/video/videos3.mp4" class="img-fluid rounded z-depth-1" controls=true %}
    </div>
</div>
